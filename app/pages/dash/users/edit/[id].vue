            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div class="flex flex-col gap-1.5 lg:col-span-3">
                ...
                <InputText id="nickname" v-model="user.nickname" aria-describedby="nickname-help"
                  placeholder="Ivan_Pupkin" class="text-sm lg:text-base" />
              ...
              <div class="flex flex-col gap-1.5 lg:col-span-3">
                ...
                <InputText id="position_psmz" v-model="user.position_psmz" placeholder="Контент-менеджер"
                  aria-describedby="position_psmz-help" class="text-sm lg:text-base" />
              ...
              <div class="flex flex-col gap-1.5">
                ...
                <InputNumber id="rank" v-model="user.rank" :min="1" :max="10" class="text-sm lg:text-base" />
              ...
              <div class="flex flex-col gap-1.5 lg:col-span-4">
                ...
                <Select v-model="user.city" :options="cities" optionLabel="name" optionValue="value"
                  placeholder="Выберите город" class="text-sm lg:text-base" />
