<template>
    <div :class="['main-bg h-screen-dynamic text-white flex flex-col items-center justify-center px-8 pt-10 pb-6 overflow-hidden', { 'fade-out': isLeaving }]"
        ...
        <div class="w-full max-w-[1280px] flex flex-col justify-between h-full min-h-[90vh] relative z-10">
            ...
            <header class="p-4 text-base text-gray-400 flex justify-center items-center">
                <div class="text-sm md:text-base text-center opacity-0 animate-fadeinUp delay-1000">
                    Пресс-служба <br class="md:hidden" /> Министерства здравоохранения
                </div>
            </header>

            <!-- Main -->
            <main
                class="flex flex-col items-center justify-center text-center px-4 object-contain opacity-0 animate-fadein delay-300">
                <div class="error-page">
                    <template v-if="error.statusCode === 404">
                        <h1 class="text-3xl md:text-6xl font-bold">404</h1>
                        <h2 class="text-2xl md:text-4xl font-bold mt-2 md:mt-4">Такой страницы нет 🙃</h2>
                    </template>
                    <template v-else>
                        <h1 class="text-3xl md:text-6xl font-bold mt-2 md:mt-4">Произошла ошибка ({{ error.statusCode }})</h1>
                    </template>
                    <p v-if="error.message" class="text-xl md:text-2xl mt-2 md:mt-4">{{ error.message }}</p>
                </div>
                ...
                <div class="mt-6 md:mt-10 opacity-0 animate-fadein delay-800">
                    ...
                    <Button class="bt-main font-bold" @click="goToMain">
                        <div class="flex items-center">
